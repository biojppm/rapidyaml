    ...
    )
{
    ...
    ___(ps.end_doc());
    ___(ps.begin_doc_expl());
    ___(ps.add_comment_leading_val(" CLV 4"));
    ___(ps.end_doc());
    ___(ps.begin_doc_expl());
    ...
    ___(ps.add_comment_footer_val(" CLV 7"));
    ___(ps.end_seq());
    ___(ps.end_doc());
    ___(ps.begin_doc_expl());
            ...
            "-STR\n")
{
    ...
    ___(ps.begin_map_val_flow());
    ___(ps.add_comment_trailing_val(" trailing map 2"));
    ___(ps.set_key_scalar_plain("foo"));
    ...
    ___(ps.add_comment_leading_val(" leading val 8"));
    ___(ps.end_doc());
    ___(ps.end_stream());
}
    ...
    )
{
    ...
    ___(ps.add_comment_leading_val(" CTV 0.3"));
    ___(ps.begin_map_val_flow());
    ___(ps.add_comment_trailing_val(" CTV 1"));
    ___(ps.add_comment_leading_key(" CLK 1.1"));
    ___(ps.end_map());
...
//fixme    //___(ps.add_comment_leading_val(" CLV 8"));
    ___(ps.end_doc());
    ___(ps.end_stream());
}
