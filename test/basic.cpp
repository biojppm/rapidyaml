...
C("nested map x2, explicit first+last level, same line",
...
C("nested map x2, explicit first+last level, same line, no spaces",
R"({foo: {foo0: 00,bar0: 01,baz0: 02},bar: {foo1: 10,bar1: 11,baz1: 12},baz: {foo2: 20,bar2: 21,baz2: 22}})",
    L{
      N{"foo", L{N{"foo0", "00"}, N{"bar0", "01"}, N{"baz0", "02"}}},
      N{"bar", L{N{"foo1", "10"}, N{"bar1", "11"}, N{"baz1", "12"}}},
...
C("nested map x2, explicit first+last level",
R"({
...
C("nested seq x3, explicit first+last level",
R"([
...
C("nested seq x4, explicit first+last level",
R"([
