...
constexpr const AllowedFailure allowed_failures[] = {
    ...
    {"9MMA", CPART_IN_YAML_ERRORS, "should not accept empty doc after %YAML directive"},
    ...
    {"G5U8", CPART_IN_YAML_ERRORS, "should not accept [-, -]"},
    ...
    {"H7TQ", CPART_IN_YAML_ERRORS, "should not accept extra words after directive"},
    {"JKF3", CPART_IN_YAML_ERRORS, "should not accept multiline unindented double quoted scalar"},
    ...
    {"9MMW", CPART_ALL, "only scalar keys allowed (keys cannot be maps or seqs)"},
    ...
    {"5TYM", CPART_IN_JSON, "malformed JSON from multiple documents"},
    {"6XDY", CPART_IN_JSON, "malformed JSON from multiple documents"},
    {"6WLZ", CPART_IN_JSON, "malformed JSON from multiple documents"},
    ...
    {"9WXW", CPART_IN_JSON, "malformed JSON from multiple documents"},
    {"JHB9", CPART_IN_JSON, "malformed JSON from multiple documents"},
    {"KSS4", CPART_IN_JSON, "malformed JSON from multiple documents"},
    {"L383", CPART_IN_JSON, "malformed JSON from multiple documents"},
    ...
    {"M6YH", e___OUT_____, "out-yaml test spec is missing a --- document token, which is required in the events"},
