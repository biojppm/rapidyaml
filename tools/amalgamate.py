...
"""
    ...
    srcfiles = [
        ...
        am.onlyif(has_evt(Event.testsuite), "src/c4/yml/evt/event_handler_test_suite.hpp"),
        ...
        am.onlyif(has_evt(Event.testsuite), "src/c4/yml/evt/event_handler_test_suite.cpp"),
