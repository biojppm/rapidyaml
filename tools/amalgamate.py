...
"""
    ...
    srcfiles = [
        ...
        am.onlyif(with_c4core_dev, "ext/c4core.dev/c4/alloc.hpp"),
        ...
        am.onlyif(with_c4core, "ext/c4core.src/c4/std/string_view_fwd.hpp"),
        ...
        am.onlyif(with_c4core, "ext/c4core.src/c4/format_base64.hpp"),
        am.onlyif(with_c4core and with_stl, am.ignfile("ext/c4core.src/c4/std/std.hpp")), # this is an umbrella include
        am.onlyif(with_c4core and with_stl, "ext/c4core.src/c4/std/span.hpp"),
        ...
        am.onlyif(with_c4core and with_stl, "ext/c4core.src/c4/std/std.hpp"),
        ...
        am.onlyif(with_c4core_dev, "ext/c4core.dev/c4/alloc.cpp"),
        ...
        am.onlyif(has_evt(Event.tree), "src/c4/yml/writer_file.hpp"),
        am.onlyif(has_evt(Event.tree), "src/c4/yml/writer_ostream.hpp"),
        ...
        am.onlyif(has_evt(Event.tree), "src/c4/yml/emit_container.hpp"),
        am.onlyif(has_evt(Event.tree), "src/c4/yml/emit_file.hpp"),
        am.onlyif(has_evt(Event.tree), "src/c4/yml/emit_ostream.hpp"),
