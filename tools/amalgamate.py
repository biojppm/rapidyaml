...
def ryml_filelist(with_stl: bool,
    ...
    hdrfiles += [
        ...
        "src/c4/yml/file.hpp",
        "src/c4/yml/tag.hpp",
        am.onlyif(has(Event.tree), "src/c4/yml/resolve_options.hpp"),
        "src/c4/yml/scalar_charconv.hpp",
        am.onlyif(has(Event.tree), "src/c4/yml/tree.hpp"),
        am.onlyif(has(Event.tree), "src/c4/yml/node.hpp"),
        am.onlyif(has(Event.ints), "src_extra/c4/yml/extra/event_ints.hpp"),
        "src/c4/yml/writer_buf.hpp",
        "src/c4/yml/writer_file.hpp",
        "src/c4/yml/writer_ostream.hpp",
        "src/c4/yml/writer.hpp",
        "src/c4/yml/detail/dbgprint.hpp",
        "src/c4/yml/detail/emit_scalar.hpp",
        "src/c4/yml/emit_options.hpp",
        "src/c4/yml/scalar_style.hpp",
        am.onlyif(has(Event.tree), "src/c4/yml/emitter.hpp"),
        am.onlyif(has(Event.tree), "src/c4/yml/emitter.def.hpp"),
        am.onlyif(has(Event.ints), "src_extra/c4/yml/extra/emitter_ints.hpp"),
        am.onlyif(has(Event.ints), "src_extra/c4/yml/extra/emitter_ints.def.hpp"),
    ...
    srcfiles += [
        ...
        am.onlyif(has(Event.ints), "src_extra/c4/yml/extra/event_ints.cpp"),
