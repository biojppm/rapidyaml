...
typedef enum : type_bits {
    ...
    DOCVAL  = DOC|VAL,
    //
    // these flags are from a work in progress and should be used with
    // care:
    //
    ...
    _WIP_SCALAR_LITERAL= _WIP_KEY_LITERAL|_WIP_VAL_LITERAL,
    _WIP_SCALAR_FOLDED = _WIP_KEY_FOLDED|_WIP_VAL_FOLDED,
    _WIP_SCALAR_SQUO   = _WIP_KEY_SQUO|_WIP_VAL_SQUO,
    _WIP_SCALAR_DQUO   = _WIP_KEY_DQUO|_WIP_VAL_DQUO,
    _WIP_SCALAR_PLAIN  = _WIP_KEY_PLAIN|_WIP_VAL_PLAIN,
    ...
    _WIP_SCALAR_STYLE  = _WIP_KEY_STYLE|_WIP_VAL_STYLE,
    _WIP_CONTAINER_STYLE_FLOW = _WIP_STYLE_FLOW_SL|_WIP_STYLE_FLOW_ML,
    _WIP_CONTAINER_STYLE_BLOCK = _WIP_STYLE_BLOCK,
    _WIP_CONTAINER_STYLE = _WIP_STYLE_FLOW_SL|_WIP_STYLE_FLOW_ML|_WIP_STYLE_BLOCK,
    _WIP_STYLE = _WIP_SCALAR_STYLE | _WIP_CONTAINER_STYLE,
    //
    KEYQUO  = _WIP_KEY_SQUO|_WIP_KEY_DQUO|_WIP_KEY_FOLDED|_WIP_KEY_LITERAL,    ///< the key is quoted by one of ', ", > or |
    VALQUO  = _WIP_VAL_SQUO|_WIP_VAL_DQUO|_WIP_VAL_FOLDED|_WIP_VAL_LITERAL,    ///< the val is quoted by one of ', ", > or |
