...
static_assert(std::is_trivially_copyable<LineCol>::value && std::is_trivially_default_constructible<LineCol>::value && std::is_trivially_destructible<LineCol>::value, "LineCol not trivial");
