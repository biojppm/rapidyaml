...
struct LineContents
{
    ...
    C4_ALWAYS_INLINE size_t current_col() const RYML_NOEXCEPT
    {
        ...
        RYML_ASSERT_BASIC(rem.str >= full.str);
    ...
    {
        RYML_ASSERT_BASIC(s.str >= full.str);
        RYML_ASSERT_BASIC(full.is_super(s));
