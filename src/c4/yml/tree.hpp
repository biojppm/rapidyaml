...
public:
    ...
    id_type root_id()       { if(m_cap == 0) { reserve(16); } _RYML_ASSERT_VISIT_(m_callbacks, m_cap > 0 && m_size > 0, this, NONE); return 0; }
    //! Get the id of the root node
    id_type root_id() const {                                 _RYML_ASSERT_VISIT_(m_callbacks, m_cap > 0 && m_size > 0, this, NONE); return 0; }
...
public:
        ...
        -> typename std::enable_if<std::is_floating_point<T>::value, csubstr>::type
    {
        ...
        if(num > rem.len)
        {
            ...
            _RYML_ASSERT_VISIT_(m_callbacks, num <= rem.len, this, NONE);
        }
...
private:
    ...
    {
        _RYML_ASSERT_VISIT_(m_callbacks, m_arena.is_super(s), this, NONE);
        _RYML_ASSERT_VISIT_(m_callbacks, m_arena.sub(0, m_arena_pos).is_super(s), this, NONE);
        ...
        _RYML_ASSERT_VISIT_(m_callbacks, next_arena.sub(0, m_arena_pos).is_super(r), this, NONE);
        return r;
    }
