...
public:
    ...
    void _copy_props(size_t dst_, Tree const* that_tree, size_t src_, type_bits src_mask)
    {
        auto      & C4_RESTRICT dst = *_p(dst_);
        auto const& C4_RESTRICT src = *that_tree->_p(src_);
    ...
    void _copy_props_wo_key(size_t dst_, Tree const* that_tree, size_t src_, type_bits src_mask)
    {
        auto      & C4_RESTRICT dst = *_p(dst_);
        auto const& C4_RESTRICT src = *that_tree->_p(src_);
