 ...
 * README](https://github.com/biojppm/rapidyaml/tree/v0.9.0?tab=readme-ov-file#quickstart-samples)
...
float: 123.456
    ...
    CHECK(tree.callbacks() == errh.callbacks());
    {
        ...
        ryml::Location ymlloc = parser.location(*errh.saved_visit_tree, errh.saved_visit_id);
