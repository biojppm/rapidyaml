...
this `test file
<https://github.com/biojppm/rapidyaml/tree/v0.12.0/api/python/tests/test_readme.py>`__
to see how the python API works, and to judge whether it may be useful to your
case.

As for performance, in a `timeit benchmark <https://github.com/biojppm/rapidyaml/tree/v0.12.0/api/python/bm/parse_bm.py>`__ comparing against
