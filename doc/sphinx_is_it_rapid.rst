...
.. Note::
   ...
   `bm/cases
   <https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/cases>`__, or
   just send us the files.

`Here’s a parsing benchmark
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/bm_parse.cpp>`__. Using
...
config file
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/cases/appveyor.yml>`__. A
...
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/cases/travis.yml>`__
or a JSON buffer from a `compile_commands.json file
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/cases/compile_commands.json>`__. You
can `see the full results here
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/results/parse.linux.i7_6800K.md>`__. Summarizing:
...
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/bm_parse.cpp>`__,
and it is reading the `compile_commands.json
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/cases/compile_commands.json>`__,
...
`Emitting benchmarks
<https://github.com/biojppm/rapidyaml/blob/v0.11.0/bm/bm_emit.cpp>`__
